...
+(function (t) {
  ...
  +(function (t) {
    ...
    var i = function (e, i) {
      ...
      (this.options = i), // Configuration options
      (this.$body = t(document.body)), // jQuery object pointing to <body> element
      (this.$element = t(e)), // jQuery object pointing to the modal's DOM element
      (this.$dialog = this.$element.find(".modal-dialog")), // jQuery object pointing to the modal's dialog part
      (this.$backdrop = null), // Used to store the modal's backdrop, initialized as null
      (this.isShown = null), // Flag indicating if the modal is currently shown, initialized as null
      (this.originalBodyPad = null), // Used to store the original body padding, initialized as null
      (this.scrollbarWidth = 0), // Used to store the scrollbar width, initialized as 0
      (this.ignoreBackdropClick = !1), // Flag indicating if backdrop clicks should be ignored, initialized as false
    
      // If the configuration options include a remote property, load remote content into the modal
      this.options.remote &&
        this.$element.find(".modal-content").load(
          this.options.remote,
          t.proxy(function () {
            this.$element.trigger("loaded.bs.modal"); // Trigger the 'loaded.bs.modal' event
          }, this)
        );
    };
